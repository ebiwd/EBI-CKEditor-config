                ...
                editor.widgets.add('btbutton', {
                    ...
                    data: function () {
                        ...
                        if (this.data.btntype) {
                            $el.removeClass('link default primary info success warning danger').addClass(this.data.btntype);
                        }

                        if (this.data.btnsize) {
                            $el.removeClass('small large').addClass(this.data.btnsize);
                        }
                    ...
                    requiredContent: 'a(button)',

                    upcast: function (element) {
                        return element.name == 'a' && element.hasClass('button');
                    }
                });
            }
        }
