CKEDITOR.plugins.add('accordionListFoundation', {
    requires: 'widget,collapsibleItemFoundation',
    icons: 'accordionListFoundation',
    hidpi: true,
    init: function (editor) {
        editor.widgets.add('accordionListFoundation', {
            button: 'Insert a new Accordion List container',
            template: '<div class="accordion-list">' +
            '   <div class="accordion panel-group accordion-list-group accordion-list-items" id="unknown" role="tablist" aria-multiselectable="true" data-accordion data-allow-all-closed="true" data-multi-expand="true" data-slide-speed="500"></div>' +
            '</div>',
            editables: {
                content: {
                    selector: 'div.accordion-list-items',
                    allowedContent: 'div(*)[*];a(!accordion*,panel*,collapsed,pull-right*)[*];p;br;ul;ol;li;strong;em;u;table[*];tbody;theader;tr;td;th;hr;a;a(*)[*];span(*)[*];img(*)[*]'
                }
            },
    ...
    onLoad: function () {
        CKEDITOR.addCss(
            '.accordion-list::before {font-size:10px;color:#000;content: "Accordion container"} ' +
            ...
            '.accordion-list-items::before {font-size:14px;color:#ccc;content: "Use the menubar to insert insert collapsible accordion items here"; position:relative;} '
        );
    }
});
